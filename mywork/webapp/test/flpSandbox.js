		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First_App",
									"targetURL": "#comFirAppmywork-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comFirAppmywork-display": {
								"semanticObject": "comFirAppmywork",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.FirApp.mywork",
									"url": sap.ui.require.toUrl("com/FirApp/mywork")
								}
							}
						}
					}
